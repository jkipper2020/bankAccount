...
//the files i had for this assignment were the BankAccount.cpp and BankAccount.h files.
...
vector<BankAccount*> openFile(string fname)
{
    ...
    while (dataFile >> type)
    {
        ...
        else if (type == "Advanced") tmp = new AdvancedSavings(ID,z);
        else if (type == "Credit")   tmp = new CreditAccount(ID,z);
        else if (type == "Checking") tmp = new CheckingAccount(ID,z);
        else
        {
            tmp = new BankAccount(ID, z);
        }
